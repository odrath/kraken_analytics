...
5. _Priority: High_ **There is PII unnecessarily exposed in business dashboards, creeating data privacy/legal risks.**
...
7.  _Priority: Medium-High_ **There is an SCD2 on static data.**
...
8. _Priority: Medium_ **Timezones mismatch and lack of documentation.**
...
12. _Priority: Medium_ **Tests are disabled or missing.**
...
13. _Priority: Medium_ **No source freshness testing.**

14. _Priority: Medium_ **No documentation - missing models and columns description.**  

15. _Priority: Low_ **No tags.**  
...
16. _Priority: Low_ **No sql style guide. No linting.**

17. _Priority: Low_ **No documented dbt-developer flow. No pre-commit hooks enforcing the rules.**
